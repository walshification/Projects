...
from projects import text


class TestPigLatin(unittest.TestCase):
    def setUp(self):
        self.translator = text.Text()
...
class TestReverse(unittest.TestCase):
    def test_any_string(self):
        new_string = text.Word('foo').reverse()
        expected = 'oof'
    ...
    def test_reverses_a_sentence_with_punctuation(self):
        ...
        reversed_sentence = text.Word(sentence).reverse()
...
class TestTextCounter(unittest.TestCase):
    def setUp(self):
        self.tc = text.TextCounter('This is a sample. '
                                   'Yep! Ygritte\'s still sad.')
